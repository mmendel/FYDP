...
#define VOLTAGE_MIN_ANGLE_PIP	0.277
#define VOLTAGE_MAX_ANGLE_PIP	1.22

#define VOLTAGE_MIN_ANGLE_MCP	0.277
#define VOLTAGE_MAX_ANGLE_MCP	1.22
...
#define VOLTAGE_TO_ANGLE_PIP(x) (float)(POT_MIN_ANGLE + (x-VOLTAGE_MIN_ANGLE_PIP)*(POT_MAX_ANGLE - POT_MIN_ANGLE)/(VOLTAGE_MAX_ANGLE_PIP - VOLTAGE_MIN_ANGLE_PIP))
#define VOLTAGE_TO_ANGLE_MCP(x) (float)(POT_MIN_ANGLE + (x-VOLTAGE_MIN_ANGLE_MCP)*(POT_MAX_ANGLE - POT_MIN_ANGLE)/(VOLTAGE_MAX_ANGLE_MCP - VOLTAGE_MIN_ANGLE_MCP))
